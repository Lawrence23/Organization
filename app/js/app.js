    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.orgview', {
              ...
              templateUrl: helper.basepath('orgview.html'),
          ...
          // })
          // .state('app.organization1', {
          //     url: '/organization1',
          //     title: 'Organization1',
          //     templateUrl: helper.basepath('organization1.html')
          // })
          // .state('app.organization2', {
          //     url: '/organization2',
          //     title: 'Organization2',
          //     templateUrl: helper.basepath('organization2.html')
          // })
          // .state('app.organization3', {
          //     url: '/Organization3',
          //     title: 'organization3',
          //     templateUrl: helper.basepath('organization3.html')
          // })
          // .state('app.organization4', {
          //     url: '/organization4',
          //     title: 'Organization4',
          //     templateUrl: helper.basepath('organization4.html')
          // })
          // 
          // CUSTOM RESOLVES
